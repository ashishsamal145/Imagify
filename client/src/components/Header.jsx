  ...
  return (
    <motion.div
      ...
      <motion.div
        ...
        className='text-stone-500 inline-flex text-center gap-2 bg-white px-6 py-1 rounded-full order border-neutral-500'>
      ...
      <motion.button
        ...
        className='sm:text-lg text-white bg-black w-auto mt-8 px-12 py-2.5 flex items-center gap-2 rounded-full'>Generate Images <img className='w-6' src={assets.star_group} alt="" /></motion.button>
      ...
      <motion.div
        ...
        className='flex gap-3 flex-wrap justify-center mt-16'>
        {
